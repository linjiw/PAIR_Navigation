...
with open('./../jackal_map_create/world-boilerplate/world_boiler_start.txt') as f:
      world_boiler_start = f.read()
with open('./../jackal_map_create/world-boilerplate/world_boiler_mid.txt') as f:
      world_boiler_mid = f.read()
with open('./../jackal_map_create/world-boilerplate/world_boiler_end.txt') as f:
      world_boiler_end = f.read()
with open('./../jackal_map_create/world-boilerplate/cylinder_define.txt') as f:
      cylinder_define = f.read()
with open('./../jackal_map_create/world-boilerplate/cylinder_place.txt') as f:
