        ...
        for file in files:
            if file.endswith(".npy"):
                ...
                if data.shape == (30, 30):
                    ...
                    plt.savefig(save_path, bbox_inches='tight', pad_inches=0)
                    plt.close(fig)
folder_path = '/home/linjiw/Downloads/jackal-map-creation/test_data/grid_files'  # replace with the path to your folder

# folder_path = './path_to_your_folder'  # replace with the path to your folder
save_folder = '/home/linjiw/Downloads/PAIRED-Jackal/dcgan/data/image_folder/train'
save_npy_as_image(folder_path, save_folder)
