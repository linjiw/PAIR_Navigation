...
class PPO():
    ...
    def update(self, rollouts, discard_grad=False):
        ...
        # print(f"rollouts.shape {rollouts.returns.shape}")
        # print(f"rollouts.returns[:-1].shape {rollouts.returns[:-1].shape}")

        # print(f"rollouts.returns[:-1] {rollouts.returns[:-1]}")
        # print(f"value_preds[:-1] {value_preds[:-1]}")
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, \
                        adv_targ = sample
                # print(f"old_action_log_probs_batch {old_action_log_probs_batch}")
                ...
                # print(f"surr1 {surr1}")
                # print(f"clip_param {self.clip_param}")
                # print(f"adv_targ {adv_targ}")
