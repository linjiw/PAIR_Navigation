...
# adversary/task_embed/clutr_RVAE/data/test/minigrid_train_100_32.txt
    parser.add_argument('--batching', default="sequential") #sequential, random
    parser.add_argument('--train-file', default="/home/linjiw/Downloads/PAIRED-Jackal/adversary/task_embed/clutr_RVAE/data/train/minigrid_train_1000_32.txt")  #
    parser.add_argument('--test-file', default="/home/linjiw/Downloads/PAIRED-Jackal/adversary/task_embed/clutr_RVAE/data/test/minigrid_train_100_32.txt")  #
